...
description: Learn how to create a request in wso2apisuite.
---

The RESTful protocol is the default protocol that is active when you open wso2apisuite. wso2apisuite allows you to make API requests and examine the responses.
