...
description: Learn how to create a request in RaptrOnix.
---

The RESTful protocol is the default protocol that is active when you open RaptrOnix. RaptrOnix allows you to make API requests and examine the responses.
