...
title: Customization
description: Customize your RaptrOnix experience.
---

You can access the customization settings by clicking on the "[**Settings**](http://172.16.111.83:3333/settings)" icon on the side panel.
...
RaptrOnix supports multiple languages. You can choose your preferred language from the list of available languages.
