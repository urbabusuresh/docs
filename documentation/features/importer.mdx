...
title: Importer
description: Migrate your data from other tools into wso2apisuite.
---

Import data from other tools into wso2apisuite. You can import data from the following tools:
...
## Import from wso2apisuite

1. Export your wso2apisuite collection/environment to a JSON file.
2. Open wso2apisuite and click on the "**Import**" button on the collection/environment section.
3. Click on the "**Import from wso2apisuite**" tab.
...
1. Open wso2apisuite and click on the "**Import**" button on the collection section.
...
There are two ways to import OpenAPI collections into wso2apisuite:

### 1. Import from File
1. Export your OpenAPI specification to a JSON file.
2. Open wso2apisuite and click on the "**Import**" button on the collection section.
...
You can import cURL commands into wso2apisuite in the following ways:

- **Copy and paste**: Copy and paste the cURL command into the wso2apisuite URL bar.
