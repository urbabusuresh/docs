...
Once you are logged into wso2apisuite, you can toggle between multiple workspaces to organize your workflow.
...
<Tabs>
  <Tab title="Create Workspace">
    <div className="image-slide">
      ![Collection 1](/images/workspaces/option-create-wk.png)
    </div>
  </Tab>
   <Tab title="Workspaces">
    <div className="image-slide">
      ![Collection 2](/images/workspaces/wk-name.png)
      ![Collection 1](/images/workspaces/wks.png)
    </div>
  </Tab>
  <Tab title="Invite User">
    <div className="image-slide">
    ![Collection 3](/images/workspaces/select-invite-user.png)
     ![Collection 3](/images/workspaces/invite-users-wk.png)
    </div>
  </Tab>
    <Tab title="Edit Workspaces">
    <div className="image-slide">
     ![Collection 3](/images/workspaces/edit-opt.png)
    ![Collection 3](/images/workspaces/edit-wk.png)
    </div>
  </Tab>
</Tabs>
...
To create a workspace, click on the **"+"** icon on the top right corner of the workspace switcher. Alternatively, you can also click on the "**Create new workspace**" button on the "[Profile](http://172.16.111.83:3333/profile)" page under the "**Workspaces**" section.
...
To delete a workspace, click on the "**Delete**" button on the workspace you want to delete on the "[Profile](http://172.16.111.83:3333/profile)" page under the "**Workspaces**" section.
