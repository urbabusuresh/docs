...
wso2apisuite provides you the ability to create and use variable throughout the app. This helps you reuse values throughout wso2apisuite just by invoking the variable name. 

wso2apisuite considers an objects within an angular brackets as a variable `<<variable>>`

<Tabs>
  <Tab title="Overall">
    <div className="image-slide">
      ![Collection 1](/images/variables/Variables.png)
    </div>
  </Tab>
   <Tab title="New Environment">
    <div className="image-slide">
      ![Collection 3](/images/variables/env-label.png)
    </div>
  </Tab>
  <Tab title="Edit Variables">
    <div className="image-slide">
      ![Collection 2](/images/variables/envs.png)
    </div>
  </Tab>
  <Tab title="Request URL">
    <div className="image-slide">
      ![Collection 3](/images/variables/variable-url.png)
    </div>
  </Tab>
...
wso2apisuite provides you different variables scopes, allowing you to use different scopes for different contexts.

1. **Global Variables:** can be accessed throughout wso2apisuite and has the broadest scope of all variables. 
...
4. **Predefined Variables:** are automatically generated at runtime and can be accessed globally throughout wso2apisuite using the `$` symbol, such as `$guid` or `$timestamp`.
...
1. **A regular variable**: allows users to reference the variable throughout wso2apisuite, and anyone can see the value associated with the variable. 
...
All secret variable values in wso2apisuite will be masked using asterisks (***). Secret Variables cannot be scoped to a request and can only be scoped in an environment or globally
...
All predefined variables are accessible throughout wso2apisuite and can be retrieved using the `$` symbol. Below is the list of predefined variables whose values are dynamically generated during the request or collection run:
