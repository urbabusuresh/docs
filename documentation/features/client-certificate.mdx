...
description: Configure client certificates for SSL authentication in RaptrOnix.
---

Add and manage client certificates  in RaptrOnix Web App using the [RaptrOnix Agent] as an interceptor to authenticate your identity when connecting to secure APIs.

### Prerequisites

Before you begin, ensure you have the following:

- If you are using the RaptrOnix Web App, make sure the **RaptrOnix Agent** is installed and configured.
...
1. Open RaptrOnix's settings page from the side bar.
