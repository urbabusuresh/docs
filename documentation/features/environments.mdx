...
An environment allows you to group together a set of variable data. You can reference the variable data you define in an environment throughout wso2apisuite when sending requests or using scripts.
