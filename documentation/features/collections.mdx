...
wso2apisuite helps you to organize your API requests with collections. You can create collections and add requests to them to share with your team or to use later. You can also import and export collections from wso2apisuite, OpenAPI, and Postman.

You can access the collections by clicking the "**Collections**" icon on the side panel.

<Tabs>
  <Tab title="1.Import Collection">
    <div className="image-slide">
      ![Collection 1](/images/collections/col-1.png)
    </div>
  </Tab>
  <Tab title="2.Chose Option">
    <div className="image-slide">
      ![Collection 2](/images/collections/col-2.png)
    </div>
  </Tab>
  <Tab title="3.Upload File">
    <div className="image-slide">
      ![Collection 3](/images/collections/col-3.png)
    </div>
  </Tab>
  <Tab title="4.Imported Collection">
    <div className="image-slide">
      ![Collection 3](/images/collections/col-5.png)
    </div>
  </Tab>
  <Tab title="5.Collections">
    <div className="image-slide">
      ![Collection 3](/images/collections/col-6.png)
    </div>
  </Tab>
</Tabs>
...
You can import and export collections from wso2apisuite, OpenAPI, and Postman.
