...
<Info>wso2apisuite CLI is currently in dev stage. Report a bug by to send a mail: sureshbabu.cherukuri@knotsolutions.com.</Info>
...
<Note>Please note that the wso2apisuite CLI exclusively supports the above three formats for importing environment variables. It **does not** offer compatibility with **Bulk Environment** exports or **any other export** format.</Note>
