...
title: RESTful
description: RESTful API testing with wso2apisuite.
---

## Platform

wso2apisuite has a built-in REST platform that can be used to execute REST API requests. The REST platform can be accessed by clicking on the `REST` tab in the menu.
...
wso2apisuite's REST API platform provides you with a fast and seamless experience to test and debug your API endpoints.
...
wso2apisuite also provides the capability to run `Tests` on the responses you receive.
