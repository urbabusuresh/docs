...
title: RESTful
description: RESTful API testing with RaptrOnix.
---

## Platform

RaptrOnix has a built-in REST platform that can be used to execute REST API requests. The REST platform can be accessed by clicking on the `REST` tab in the menu.
...
RaptrOnix's REST API platform provides you with a fast and seamless experience to test and debug your API endpoints.
...
RaptrOnix also provides the capability to run `Tests` on the responses you receive.
